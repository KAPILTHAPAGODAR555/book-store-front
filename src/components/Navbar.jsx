  ...
  return (
   <header className="max-w-screen-2xl mx-auto px-4 py-6">
    <nav className = "flex justify-between items-center">
        {/* left side */}
  <div className = "flex items-center md:gap-16 gap-4"> <Link to="/">
  <FiAlignLeft className="size-6"/>
  </Link></div>
    {/* search input */}
    <div className="relative sm:w-72 w-40 space-x-2">
<MdOutlineManageSearch className="absolute inline-block left-3 inset-y-2" />
