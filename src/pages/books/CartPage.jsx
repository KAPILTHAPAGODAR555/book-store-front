                ...
                cartItems.map((product)=>(
                  ...
                  <div className="ml-4 flex flex-1 flex-col">
                    ...
                    <div className="flex flex-1 flex-wrap items-end justify-between space-y-2 text-sm">
                      ...
                      <div className="flex">
                        <button 
                        onClick={()=>handleRemoveFromCart(product)} type="button" className="font-medium text-indigo-600 hover:text-indigo-500">
                          Remove
                        </button>
                      </div>
                    </div>
